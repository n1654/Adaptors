...
function quagga_connect($sd_ip_addr = null, $login = null, $passwd = null, $adminpasswd = null, $port_to_use = null) {
    global $sms_sd_ctx;
    try {
        $sms_sd_ctx = new QuaggaSshConnection($sd_ip_addr, $login, $passwd, $adminpasswd, $port_to_use);
...
class QuaggaSshConnection extends SshConnection {

    public function do_post_connect() {

        echo "***Call Quagga Do_post_connect***\n";
        unset($tab);
        $tab[0] = '#';
        $tab[1] = '$';
        $tab[2] = '>';
